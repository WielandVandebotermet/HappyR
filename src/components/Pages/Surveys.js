      ...
      <div class=" min-h-screen">
          ...
          <div class="flex flex-row p-3 justify-center">
            <NavLink to="/">
              <div class="block max-w-sm m-4 p-6 rounded-lg border-gray-900  hover:border-blue-600 border">
                <div class="">
                <h5 class="text-center mb-2 text-2xl font-bold tracking-tight text-gray-900">Date | Surveys</h5>
                </div>
                <p class="text-right text-sm">Group</p>
              </div>
            </NavLink>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          ...
          <div class="flex justify-center">
            <button type="button" class="py-3.5 mx-3 w-full max-w-screen-sm text-base font-medium text-white bg-[#170699] hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center">Create Survey</button>
          </div>
        </NavLink>
        <NavLink to="/">
          <div class="flex justify-center">
