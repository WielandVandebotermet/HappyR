        ...
        <div className="flex flex-col h-auto">
          <div className="p-3 m-auto">
            <div className="flex flex-row p-3 justify-center">
                <div className="block max-w-sm m-4 p-6  border rounded-lg border-gray-900  hover:border-blue-600">
                <NavLink to="/Surveys">
            ...
            <div className="flex flex-row p-3 justify-center">
              <div className="w-1/2 block max-w-sm m-4 p-6 border rounded-lg border-gray-900  hover:border-blue-600">
                <NavLink to="/Groups" >
              ...
              <div className="w-1/2 block max-w-sm m-4 p-6 rounded-lg shadow border border-gray-900  hover:border-blue-600">
                <NavLink to="/Results">
            ...
            <NavLink to="/Surveys#Unanswered">
              <div className="flex justify-center">
                <button type="button" className="p-5 m-5 sm:w-fit  md:w-full font-medium text-[#170699] border-[5px] border-[#170699] hover:bg-[#170699c0] hover:text-white rounded-lg text-center">Fill in survey</button>
              </div>
            </NavLink>
          </div>
        </div>
