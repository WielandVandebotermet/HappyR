...
function CreateSurveys() {
  ...
  useEffect(() => {
    ...
    return (
      <div>
        <div class={" "+ (GroupPage ? 'hidden' : 'block')}>
          <div class="flex flex-col p-3">
            ...
            <h1 className={"p-2 text-center text-4xl " + (id === "0" ? 'block' : 'hidden')}>Create new survey</h1>
              ...
              <div class="w-full md:w-1/3 md:flex flex-col">
          ...
          <div class="flex flex-col">
            <div class="flex justify-center">
              <div  class="w-1/2 flex justify-center">
                <button onClick={() => setGroupPage(!GroupPage)} type="button" class="py-3.5 my-5 mx-3 w-9/12 text-base font-medium text-white bg-[#170699] hover:bg-blue-600 rounded-lg text-center">Select Group(s)</button>
              </div>
            </div>
            <div class="flex flex-col">
              <div class="flex justify-center">
                <Link to={"/SelectTemplate/0"} class="w-1/2 flex justify-center">
                  <button type="button" class="py-3.5 mx-3 w-9/12 text-base font-medium text-white bg-[#170699] hover:bg-blue-600 rounded-lg text-center">Create Survey</button>
                </Link>
              </div>
            </div>
            <Back />
        ...
        <div class={" "+ (GroupPage ? 'block' : 'hidden')}>
          <div class="flex flex-col p-3">
            ...
            <div class="flex justify-center">
            <div class="w-1/2">
              <button onClick={() => setGroupPage(!GroupPage)} type="button" class="py-3.5 my-7 mx-3 w-full font-medium text-white bg-[#170699] hover:text-[#AB1AAB] hover:underline rounded-lg text-center">Back</button>
            </div>
          </div>
          </div>
      </div>
